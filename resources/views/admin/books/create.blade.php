    ...
    <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="space-y-1 md:col-span-3">
                ...
                <input type="url" name="gumroad_url" id="gumroad_url" value="{{ old('gumroad_url') }}" placeholder="https://gumroad.com/l/your-book" class="w-full bg-slate-50 border border-slate-200 text-slate-800 text-sm rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary block p-3 outline-none transition-all">
