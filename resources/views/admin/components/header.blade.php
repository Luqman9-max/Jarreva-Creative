<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full pt-1">
    <div class="flex flex-col gap-1">
        <h1 class="text-[#181411] dark:text-white text-3xl font-extrabold leading-tight tracking-tight">Dashboard Overview</h1>
        <p class="text-[#64748b] dark:text-[#94a3b8] text-sm font-medium">Welcome back, {{ Auth::guard('admin')->user()->name }}! Here's what's happening today.</p>
    </div>
    <div class="flex items-center gap-4">
        ...
        <button class="relative group p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" type="button">
